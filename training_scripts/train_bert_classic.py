...
if not FEW:
    BERT_SAVE_PATH = (
        "/home/rcala/PromptMBTI_Masters/models/" + "bert" + "_" + TRAITS[CURR_TRAIT] + "_classic_5e-5"
    )
else:
    BERT_SAVE_PATH = (
...
model = BertForSequenceClassification.from_pretrained(BERT_MODEL_PATH,config=model_config)
